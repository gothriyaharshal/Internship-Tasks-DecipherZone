...
>>>>>>>>>>>>>>>>
Yes, exactly. In tight coupling, usually for every different engine type you create a separate class (or modify the existing class).
